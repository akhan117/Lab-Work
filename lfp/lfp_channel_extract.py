...
# This program extracts the channels you specify from the data created by Spike2_to_HDF5.
if __name__ == "__main__":
    # The program asks the user to select a filed created by spike2_to_hdf5.
    print("Pick the file you want to extract channels from")
    read_from = askopenfilename()

    # If the default channels exist, they will be used. Otherwise, the user will be asked to provide channels.
